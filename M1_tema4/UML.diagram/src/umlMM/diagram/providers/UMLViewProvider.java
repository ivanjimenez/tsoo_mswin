...
public class UMLViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return umlMM.diagram.edit.parts.PackageEditPart.MODEL_ID.equals(op
				.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = umlMM.diagram.part.UMLVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = umlMM.diagram.part.UMLVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!umlMM.diagram.providers.UMLElementTypes
				...
				if (!umlMM.diagram.edit.parts.PackageEditPart.MODEL_ID
						.equals(umlMM.diagram.part.UMLVisualIDRegistry
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (umlMM.diagram.part.UMLVisualIDRegistry
				.getVisualID(elementTypeHint)) {
		case umlMM.diagram.edit.parts.AssociatonEditPart.VISUAL_ID:
			return createAssociaton_4001(getSemanticElement(semanticAdapter),
	 ...
	 * @generated
	 */
	public Node createDatatype_2001(EObject domainElement, View containerView,
	 ...
	 * @generated
	 */
	public Edge createAssociaton_4001(EObject domainElement,
		...
		edge.setType(umlMM.diagram.part.UMLVisualIDRegistry
	...
	private void stampShortcut(View containerView, Node target) {
		if (!umlMM.diagram.edit.parts.PackageEditPart.MODEL_ID
			...
			shortcutAnnotation
					.getDetails()
					.put("modelID", umlMM.diagram.edit.parts.PackageEditPart.MODEL_ID); //$NON-NLS-1$
