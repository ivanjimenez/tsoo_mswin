...
public class ClassEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new umlMM.diagram.edit.policies.ClassItemSemanticEditPolicy());
		installEditPolicy(EditPolicy.LAYOUT_ROLE, createLayoutEditPolicy());
		installEditPolicy(EditPolicyRoles.OPEN_ROLE,
				new umlMM.diagram.edit.policies.OpenDiagramEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof umlMM.diagram.edit.parts.ClassNameEditPart) {
			((umlMM.diagram.edit.parts.ClassNameEditPart) childEditPart)
	...
	public List<IElementType> getMARelTypesOnSource() {
		...
		types.add(umlMM.diagram.providers.UMLElementTypes.Associaton_4001);
		return types;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof umlMM.diagram.edit.parts.ClassEditPart) {
			types.add(umlMM.diagram.providers.UMLElementTypes.Associaton_4001);
		}
		return types;
	}
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == umlMM.diagram.providers.UMLElementTypes.Associaton_4001) {
