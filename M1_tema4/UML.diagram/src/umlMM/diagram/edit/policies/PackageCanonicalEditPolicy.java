...
public class PackageCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return umlMM.UmlMMPackage.eINSTANCE.getPackage_Classifier();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<umlMM.diagram.part.UMLNodeDescriptor> childDescriptors = umlMM.diagram.part.UMLDiagramUpdater
				.getPackage_1000SemanticChildren(viewObject);
		for (umlMM.diagram.part.UMLNodeDescriptor d : childDescriptors) {
	...
	protected void refreshSemantic() {
		...
		for (Iterator<umlMM.diagram.part.UMLNodeDescriptor> descriptorsIterator = childDescriptors
				.iterator(); descriptorsIterator.hasNext();) {
			umlMM.diagram.part.UMLNodeDescriptor next = descriptorsIterator
					.next();
			String hint = umlMM.diagram.part.UMLVisualIDRegistry.getType(next
					.getVisualID());
		...
		for (umlMM.diagram.part.UMLNodeDescriptor next : childDescriptors) {
			String hint = umlMM.diagram.part.UMLVisualIDRegistry.getType(next
					.getVisualID());
	...
	private Collection<IAdaptable> refreshConnections() {
		...
		Collection<umlMM.diagram.part.UMLLinkDescriptor> linkDescriptors = collectAllLinks(
				getDiagram(), domain2NotationMap);
		Collection existingLinks = new LinkedList(getDiagram().getEdges());
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
				.hasNext();) {
			Edge nextDiagramLink = (Edge) linksIterator.next();
			int diagramLinkVisualID = umlMM.diagram.part.UMLVisualIDRegistry
			...
			for (Iterator<umlMM.diagram.part.UMLLinkDescriptor> linkDescriptorsIterator = linkDescriptors
					.iterator(); linkDescriptorsIterator.hasNext();) {
				umlMM.diagram.part.UMLLinkDescriptor nextLinkDescriptor = linkDescriptorsIterator
						.next();
	 ...
	 * @generated
	 */
	private Collection<umlMM.diagram.part.UMLLinkDescriptor> collectAllLinks(
		...
		case umlMM.diagram.edit.parts.AssociatonEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(umlMM.diagram.part.UMLDiagramUpdater
						.getAssociaton_4001ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
	...
	private Collection<IAdaptable> createConnections(
			Collection<umlMM.diagram.part.UMLLinkDescriptor> linkDescriptors,
			Map<EObject, View> domain2NotationMap) {
		LinkedList<IAdaptable> adapters = new LinkedList<IAdaptable>();
		for (umlMM.diagram.part.UMLLinkDescriptor nextLinkDescriptor : linkDescriptors) {
